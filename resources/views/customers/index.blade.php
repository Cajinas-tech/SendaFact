...
@section('title_badge', 'GESTIÃ“N DE CLIENTES')
...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-xs text-slate-400 mt-0.5">Control de cartera de clientes, lÃ­mites de crÃ©dito y contacto</p>
        </div>
    </div>
            ...
            <div class="glass-card rounded-3xl p-6 border border-slate-200/90 dark:border-slate-800 shadow-xs space-y-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400">Tel: {{ $c->phone ?? 'Sin telÃ©fono' }}</p>
                    </div>
                </div>
                ...
                <div class="p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-700/60 space-y-1 text-xs">
                    <div class="flex justify-between">
                        ...
                        <span class="font-mono font-bold text-rose-600">${{ number_format($c->current_debt, 2) }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-slate-400">LÃ­mite CrÃ©dito:</span>
                        <span class="font-mono font-bold text-slate-700 dark:text-slate-300">${{ number_format($c->credit_limit, 2) }}</span>
                    </div>
                </div>
