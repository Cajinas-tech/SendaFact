@extends('layouts.app')
@section('title_badge', 'RESPALDO Y SEGURIDAD')
@section('content')
<div class="glass-card rounded-3xl p-8 border border-slate-200/90 dark:border-slate-800 text-center max-w-xl mx-auto space-y-4">
    ...
    <p class="text-xs text-slate-400">Tus datos están sincronizados en la nube con Supabase (PostgreSQL) con respaldos automáticos y cifrado SSL.</p>
</div>
@endsection