    ...
    setCart((currentCart) => {
      ...
      return [
        ...currentCart,
        {
          ...
          name: product.name,
          sku: product.sku,
          price_cordobas: parseFloat(product.price_cordobas as any || 0),
          price_usd: parseFloat(product.price_usd as any || (product.price_cordobas / exchangeRate)),
          quantity: 1,
        },
      ];
    });
    ...
    try {
      ...
      const newSale: Sale = {
        ...
        items: cart.map(i => ({
          ...
          product_name: i.name,
          quantity: i.quantity,
          unit_price_cordobas: i.price_cordobas,
          total_cordobas: i.price_cordobas * i.quantity
        })),
